          ...
          <tr>
            <td style="padding: 40px 32px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="https://coezmuc.vercel.app/my-subscriptions" style="display: inline-block; background-color: #3D2C1E; color: #FAF7F2; font-size: 11px; letter-spacing: 0.2em; text-transform: uppercase; padding: 14px 32px; border-radius: 8px; text-decoration: none;">Minhas inscrições</a>
                  </td>
                </tr>
              </table>
            </td>
